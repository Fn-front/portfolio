...
test('Screen Shot useCase flex', async ({ page }) => {
  await page.goto('http://localhost:2937/code/codeView/ui/layout/flex/');
  await page.screenshot({ path: 'public/assets/img/codeView/ui/layout/flex.png', clip: { x: x, y: y, width: width, height: height } });
});
