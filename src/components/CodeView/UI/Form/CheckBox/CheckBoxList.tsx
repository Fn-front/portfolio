      ...
      <ComponentWrapper styleCode={content}>
        <div className='l_form_list'>
          <div className='l_form_list_item'>
            <div className='l_form_column_2 l_form_column_align_center'>
              <div className='l_form_column_item'>
                <input type='checkbox' className='c_check_box' name='' id='checkbox2' />
              </div>
              <div className='l_form_column_item'>
          ...
          <div className='l_form_list_item'>
            <div className='l_form_column_2 l_form_column_align_center'>
              <div className='l_form_column_item'>
                <input type='checkbox' className='c_check_box' name='' id='checkbox3' />
              </div>
              <div className='l_form_column_item'>
          ...
          <div className='l_form_list_item'>
            <div className='l_form_column_2 l_form_column_align_center'>
              <div className='l_form_column_item'>
                <input type='checkbox' className='c_check_box' name='' id='checkbox4' />
              </div>
              <div className='l_form_column_item'>
          ...
          <div className='l_form_list_item'>
            <div className='l_form_column_2 l_form_column_align_center'>
              <div className='l_form_column_item'>
                <input type='checkbox' className='c_check_box' name='' id='checkbox5' />
              </div>
              <div className='l_form_column_item'>
          ...
          <div className='l_form_list_item'>
            <div className='l_form_column_2 l_form_column_align_center'>
              <div className='l_form_column_item'>
                <input type='checkbox' className='c_check_box' name='' id='checkbox6' />
              </div>
              <div className='l_form_column_item'>
          ...
          <div className='l_form_list_item'>
            <div className='l_form_column_2 l_form_column_align_center'>
              <div className='l_form_column_item'>
                <input type='checkbox' className='c_check_box' name='' id='checkbox7' />
              </div>
              <div className='l_form_column_item'>
