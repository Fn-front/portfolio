      ...
      <ComponentWrapper styleCode={content}>
        <div className='l_form_list'>
          ...
          <div className='l_form_list_item'>
            <div className='l_form_column_2 l_form_column_align_center'>
              <div className='l_form_column_item'>
                <input type='checkbox' className='c_check_box' name='' id='checkbox9' />
              </div>
              <div className='l_form_column_item'>
          ...
          <div className='l_form_list_item'>
            <div className='l_form_column_2 l_form_column_align_center'>
              <div className='l_form_column_item'>
                <input type='checkbox' className='c_check_box' name='' id='checkbox10' />
              </div>
              <div className='l_form_column_item'>
          ...
          <div className='l_form_list_item'>
            <div className='l_form_column_2 l_form_column_align_center'>
              <div className='l_form_column_item'>
                <input type='checkbox' className='c_check_box' name='' id='checkbox11' />
              </div>
              <div className='l_form_column_item'>
          ...
          <div className='l_form_list_item'>
            <div className='l_form_column_2 l_form_column_align_center'>
              <div className='l_form_column_item'>
                <input type='checkbox' className='c_check_box' name='' id='checkbox12' />
              </div>
              <div className='l_form_column_item'>
          ...
          <div className='l_form_list_item'>
            <div className='l_form_column_2 l_form_column_align_center'>
              <div className='l_form_column_item'>
                <input type='checkbox' className='c_check_box' name='' id='checkbox13' />
              </div>
              <div className='l_form_column_item'>
